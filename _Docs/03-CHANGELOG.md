...
- **Expansão massiva do banco de aleatoriedades** (`data/aleatoriedades.csv`) com **500 linhas completas** distribuídas em 4 colunas independentes: **Personagem**, **Localizacao**, **Filme / Livro** e **Adjetivo / Característica**.
